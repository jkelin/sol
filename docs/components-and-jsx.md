...
Text, primitive branches, raw-text elements, compiler-folded string attributes, and controlled or bound text-control values replace U+0000 with U+FFFD, matching browser HTML parsing across mounting, SSR, and hydration.
